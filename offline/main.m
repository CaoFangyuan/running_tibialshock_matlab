...
sub.normal.runstart=835;
sub.normal.runstop=9322;
sub.normal.accstart=10630;
sub.normal.accstop=100200;
sub.normal.runacc=sub.normal.acc(sub.normal.accstart:sub.normal.accstop);
sub.normal.forcestart=5753;
% sub.normal.forcestop=94420;
sub.normal.forcestop=95323;
...
sub.in.runstart=804;
sub.in.runstop=9633;
sub.in.accstart=13910;
sub.in.accstop=105900;
sub.in.runacc=sub.in.acc(sub.in.accstart:sub.in.accstop);
sub.in.forcestart=6022;
%sub.in.forcestop=97110;
sub.in.forcestop=98012;
...
sub.out.runstart=798;
sub.out.runstop=9443;
sub.out.accstart=13610;
sub.out.accstop=102400;
sub.out.runacc=sub.out.acc(sub.out.accstart:sub.out.accstop);
sub.out.forcestart=5799;
%sub.out.forcestop=93180;
sub.out.forcestop=94589;
