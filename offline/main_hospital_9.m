function sub=main_hospital_9(SubNumber)
...
sub.normal.force(:,1)=-Sub.rawData.Vicon.Force.NORMAL(:,5);
[b,a] = butter(ORDER,FORCE_FILTER/(FORCE_SAMPLE/2));
sub.normal.force = filter(b,a,sub.normal.force);
sub.normal.cop=Sub.rawData.Vicon.Force.NORMAL(:,9:11);
sub.normal.cop(:,1)=sub.normal.cop(:,1)+267.4;
sub.normal.cop(:,2)=sub.normal.cop(:,2)+784;
sub.normal.cop = filter(b,a,sub.normal.cop);
sub.normal.leftcop=Sub.rawData.Vicon.Force.NORMAL(:,18:20);
sub.normal.leftcop(:,1)=sub.normal.leftcop(:,1)+830.1;
sub.normal.leftcop(:,2)=sub.normal.leftcop(:,2)+784;
...
sub.normal.c7=Sub.rawData.Vicon.Position.NORMAL.C7(:,1:3);
sub.normal.lpsi=Sub.rawData.Vicon.Position.NORMAL.LPSI(:,1:3);
sub.normal.rpsi=Sub.rawData.Vicon.Position.NORMAL.RPSI(:,1:3);
sub.normal.right_cal=Sub.rawData.Vicon.Position.NORMAL.LHEE(:,1:3);
sub.normal.right_toe=Sub.rawData.Vicon.Position.NORMAL.LTOE(:,1:3);
...
sub.normal.c7=(RotMat_ViconToAnatomical*(sub.normal.c7)')';
sub.normal.lpsi=(RotMat_ViconToAnatomical*(sub.normal.lpsi)')';
sub.normal.rpsi=(RotMat_ViconToAnatomical*(sub.normal.rpsi)')';
sub.normal.right_cal=(RotMat_ViconToAnatomical*(sub.normal.right_cal)')';
sub.normal.right_toe=(RotMat_ViconToAnatomical*(sub.normal.right_toe)')';
...
sub.in.force(:,1)=-Sub.rawData.Vicon.Force.NI(:,5);
[b,a] = butter(4,FORCE_FILTER/(FORCE_SAMPLE/2));
sub.in.force = filter(b,a,sub.in.force);
sub.in.cop=Sub.rawData.Vicon.Force.NI(:,9:11);
sub.in.cop(:,1)=sub.in.cop(:,1)+267.4;
sub.in.cop(:,2)=sub.in.cop(:,2)+784;
sub.in.cop = filter(b,a,sub.in.cop);
sub.in.leftcop=Sub.rawData.Vicon.Force.NI(:,18:20);
sub.in.leftcop(:,1)=sub.in.leftcop(:,1)+830.1;
sub.in.leftcop(:,2)=sub.in.leftcop(:,2)+784;
...
sub.in.c7=Sub.rawData.Vicon.Position.NI.C7(:,1:3);
sub.in.lpsi=Sub.rawData.Vicon.Position.NI.LPSI(:,1:3);
sub.in.rpsi=Sub.rawData.Vicon.Position.NI.RPSI(:,1:3);
sub.in.right_cal=Sub.rawData.Vicon.Position.NI.LHEE(:,1:3);
sub.in.right_toe=Sub.rawData.Vicon.Position.NI.LTOE(:,1:3);
...
sub.in.c7=(RotMat_ViconToAnatomical*(sub.in.c7)')';
sub.in.lpsi=(RotMat_ViconToAnatomical*(sub.in.lpsi)')';
sub.in.rpsi=(RotMat_ViconToAnatomical*(sub.in.rpsi)')';
sub.in.right_cal=(RotMat_ViconToAnatomical*(sub.in.right_cal)')';
sub.in.right_toe=(RotMat_ViconToAnatomical*(sub.in.right_toe)')';
% filter OUT force and cop with 4order, 50HZ Butterworth, lowpass filter
sub.out.force(:,1)=-Sub.rawData.Vicon.Force.NO(:,5);
[b,a] = butter(4,FORCE_FILTER/(FORCE_SAMPLE/2));
sub.out.force = filter(b,a,sub.out.force);
sub.out.cop=Sub.rawData.Vicon.Force.NO(:,9:11);
sub.out.cop(:,1)=sub.out.cop(:,1)+267.4;
sub.out.cop(:,2)=sub.out.cop(:,2)+784;
sub.out.cop = filter(b,a,sub.out.cop);
sub.out.leftcop=Sub.rawData.Vicon.Force.NO(:,18:20);
sub.out.leftcop(:,1)=sub.out.leftcop(:,1)+830.1;
sub.out.leftcop(:,2)=sub.out.leftcop(:,2)+784;
...
sub.out.c7=Sub.rawData.Vicon.Position.NO.C7(:,1:3);
sub.out.lpsi=Sub.rawData.Vicon.Position.NO.LPSI(:,1:3);
sub.out.rpsi=Sub.rawData.Vicon.Position.NO.RPSI(:,1:3);
sub.out.right_cal=Sub.rawData.Vicon.Position.NO.LHEE(:,1:3);
sub.out.right_toe=Sub.rawData.Vicon.Position.NO.LTOE(:,1:3);
...
sub.out.c7=(RotMat_ViconToAnatomical*(sub.out.c7)')';
sub.out.lpsi=(RotMat_ViconToAnatomical*(sub.out.lpsi)')';
sub.out.rpsi=(RotMat_ViconToAnatomical*(sub.out.rpsi)')';
sub.out.right_cal=(RotMat_ViconToAnatomical*(sub.out.right_cal)')';
sub.out.right_toe=(RotMat_ViconToAnatomical*(sub.out.right_toe)')';
...
sub.normal.cop=sub.normal.cop-[-12.3939,-4.4905,12.7848];
sub.in.cop=sub.in.cop-[-12.3939,-4.4905,12.7848];
sub.out.cop=sub.out.cop-[-12.3939,-4.4905,12.7848];
sub.normal.leftcop=sub.normal.leftcop-[0.34,-9.77,11.6];
sub.in.leftcop=sub.in.leftcop-[0.34,-9.77,11.6];
sub.out.leftcop=sub.out.leftcop-[0.34,-9.77,11.6];

sub.normal.cop=(RotMat_ViconToAnatomical*(sub.normal.cop)')';
sub.in.cop=(RotMat_ViconToAnatomical*(sub.in.cop)')';
sub.out.cop=(RotMat_ViconToAnatomical*(sub.out.cop)')';
sub.normal.leftcop=(RotMat_ViconToAnatomical*(sub.normal.leftcop)')';
sub.in.leftcop=(RotMat_ViconToAnatomical*(sub.in.leftcop)')';
sub.out.leftcop=(RotMat_ViconToAnatomical*(sub.out.leftcop)')';
...
sub.normal.runstart=458;
sub.normal.runstop=8963;
sub.normal.accstart=8240;
sub.normal.accstop=94630;
sub.normal.runacc=sub.normal.acc(sub.normal.accstart:sub.normal.accstop);
sub.normal.forcestart=4461;
% sub.normal.forcestop=94420;
sub.normal.forcestop=91330;
...
for i=sub.normal.runstart:sub.normal.runstop
    if (sub.normal.meanforce(i)<=FORCE_THRESHOLD && sub.normal.meanforce(i+1)>=FORCE_THRESHOLD)
        ...
        sub.normal.StrikeIndex(sub.normal.stepnumber,1)=StrikeIndex(sub.normal.meancop(i+1,:),sub.normal.right_cal(i+1,:),sub.normal.right_toe(i+1,:));
    end
...
sub.in.runstart=384;
sub.in.runstop=8962;
sub.in.accstart=6841;
sub.in.accstop=94150;
sub.in.runacc=sub.in.acc(sub.in.accstart:sub.in.accstop);
sub.in.forcestart=3852;
%sub.in.forcestop=97110;
sub.in.forcestop=90140;
...
for i=sub.in.runstart:sub.in.runstop
    if (sub.in.meanforce(i)<=FORCE_THRESHOLD && sub.in.meanforce(i+1)>=FORCE_THRESHOLD)
        ...
        sub.in.StrikeIndex(sub.in.stepnumber,1)=StrikeIndex(sub.in.meancop(i+1,:),sub.in.right_cal(i+1,:),sub.in.right_toe(i+1,:));
    end
...
for i=sub.out.runstart:sub.out.runstop
    if (sub.out.meanforce(i)<=86 && sub.out.meanforce(i+1)>=86)
        sub.out.stepnumber=sub.out.stepnumber+1;
        sub.out.StepStart( sub.out.stepnumber,1)=i+1;
        sub.out.StrikeIndex(sub.out.stepnumber,1)=StrikeIndex(sub.out.meancop(i+1,:),sub.out.right_cal(i+1,:),sub.out.right_toe(i+1,:));
    end
    
    if sub.out.stepnumber>0
        if (sub.out.meanforce(i)>=86 && sub.out.meanforce(i+1)<=86) && i>sub.out.StepStart( sub.out.stepnumber,1)
