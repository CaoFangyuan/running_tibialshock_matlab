function sub=main_sub2(SubNumber)
...
sub.normal.runstart=897;
sub.normal.runstop=10040;
sub.normal.accstart=11050;
sub.normal.accstop=106300;
sub.normal.runacc=sub.normal.acc(sub.normal.accstart:sub.normal.accstop);
sub.normal.forcestart=5269;
% sub.normal.forcestop=94420;
sub.normal.forcestop=100200;
...
sub.in.runstart=625;
sub.in.runstop=9277;
sub.in.accstart=12660;
sub.in.accstop=99860;
sub.in.runacc=sub.in.acc(sub.in.accstart:sub.in.accstop);
sub.in.forcestart=6053;
%sub.in.forcestop=97110;
sub.in.forcestop=92770;
...
sub.out.runstart=580;
sub.out.runstop=9322;
sub.out.accstart=10290;
sub.out.accstop=97970;
sub.out.runacc=sub.out.acc(sub.out.accstart:sub.out.accstop);
sub.out.forcestart=5507;
%sub.out.forcestop=93180;
sub.out.forcestop=93210;
