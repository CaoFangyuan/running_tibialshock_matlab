function sub=main_hospital(SubNumber)
...
sub.normal.right_cal=Sub.rawData.Vicon.Position.NORMAL.RHEE(:,1:3);
sub.normal.right_toe=Sub.rawData.Vicon.Position.NORMAL.RTOE(:,1:3);
...
sub.in.right_cal=Sub.rawData.Vicon.Position.NI.RHEE(:,1:3);
sub.in.right_toe=Sub.rawData.Vicon.Position.NI.RTOE(:,1:3);
...
sub.in.c7=(RotMat_ViconToAnatomical*(sub.normal.c7)')';
...
sub.out.right_cal=Sub.rawData.Vicon.Position.NO.RHEE(:,1:3);
sub.out.right_toe=Sub.rawData.Vicon.Position.NO.RTOE(:,1:3);
...
sub.normal.runstart=1193;
sub.normal.runstop=9829;
sub.normal.accstart=17040;
sub.normal.accstop=110400;
sub.normal.runacc=sub.normal.acc(sub.normal.accstart:sub.normal.accstop);
sub.normal.forcestart=6221;
% sub.normal.forcestop=94420;
sub.normal.forcestop=99620;
...
sub.in.stepnumber=0;
sub.in.runstart=430;
sub.in.runstop=10130;
sub.in.accstart=7211;
sub.in.accstop=105600;
sub.in.runacc=sub.in.acc(sub.in.accstart:sub.in.accstop);
sub.in.forcestart=3972;
%sub.in.forcestop=97110;
sub.in.forcestop=101300;
...
sub.out.runstart=569;
sub.out.runstop=10190;
sub.out.accstart=6960;
sub.out.accstop=102400;
sub.out.runacc=sub.out.acc(sub.out.accstart:sub.out.accstop);
sub.out.forcestart=4935;
%sub.out.forcestop=93180;
sub.out.forcestop=103600;
