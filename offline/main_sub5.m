function sub=main_sub5(SubNumber)
...
sub.normal.right_cal=Sub.rawData.Vicon.Position.NORMAL(:,60:62);
sub.normal.right_toe=Sub.rawData.Vicon.Position.NORMAL(:,63:65);
sub.normal.right_toec=Sub.rawData.Vicon.Position.NORMAL(:,66:69);
...
sub.in.right_cal=Sub.rawData.Vicon.Position.NI(:,60:62);
sub.in.right_toe=Sub.rawData.Vicon.Position.NI(:,63:65);
sub.in.right_toec=Sub.rawData.Vicon.Position.NI(:,66:69);
[b2,a2] = butter(4,MARKER_FILTER/(MARKER_SAMPLE/2));
...
sub.out.right_cal=Sub.rawData.Vicon.Position.NO(:,60:62);
sub.out.right_toe=Sub.rawData.Vicon.Position.NO(:,63:65);
sub.out.right_toec=Sub.rawData.Vicon.Position.NO(:,66:69);
[b2,a2] = butter(4,MARKER_FILTER/(MARKER_SAMPLE/2));
...
sub.normal.leftcop=sub.normal.leftcop-[-13.27,-32.36,-34.18];
sub.in.leftcop=sub.in.leftcop-[-13.27,-32.36,-34.18];
sub.out.leftcop=sub.out.leftcop-[-13.27,-32.36,-34.18];
...
sub.normal.runstart=457;
sub.normal.runstop=9201;
sub.normal.accstart=9004;
sub.normal.accstop=96940;
sub.normal.runacc=sub.normal.acc(sub.normal.accstart:sub.normal.accstop);
sub.normal.forcestart=4716;
% sub.normal.forcestop=94420;
sub.normal.forcestop=91920;
...
sub.in.runstart=367;
sub.in.runstop=9088;
sub.in.accstart=10850;
sub.in.accstop=97970;
sub.in.runacc=sub.in.acc(sub.in.accstart:sub.in.accstop);
sub.in.forcestart=3763;
%sub.in.forcestop=97110;
sub.in.forcestop=90880;
...
sub.out.runstart=512;
sub.out.runstop=8934;
sub.out.accstart=9417;
sub.out.accstop=93600;
sub.out.runacc=sub.out.acc(sub.out.accstart:sub.out.accstop);
sub.out.forcestart=5081;
%sub.out.forcestop=93180;
sub.out.forcestop=89300;
